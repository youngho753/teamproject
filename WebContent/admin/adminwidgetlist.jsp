...
<div align="center">
  <table width="1200" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td colspan="3"><span class="style1">위젯리스트</span></td>
      <td width="10" rowspan="4">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" rowspan="2"><table width="1180" border="0" cellspacing="0" cellpadding="0">
		...
		<!-- 번호 들어가는부분 -->
          ...
          <td width="811"><span class="style2">말모이</span><span class="style9">(25)</span></td>
        ...
        <tr>
          ...
          <td><span class="style2">내안에 그놈</span><span class="style9">(52)</span></td>
        ...
        <tr>
          ...
          <td><span class="style6"></span></td>
          <td><span class="style2">주먹왕 랄프2<span class="style12">(52)</span></span></td>
        ...
        <tr>
          ...
          <td><span class="style2">주먹왕 랄프2<span class="style12">(52)</span></span></td>
          <td colspan="2"><div align="center" class="style6">01.20</div></td>
          <td><div align="center" class="style6">22</div></td>
        </tr>
        <tr>
          <td colspan="6"><hr></td>
        </tr>
        ...
        <tr>
          ...
          <td width="6">&nbsp;</td>
          <td><input type="submit" name="Submit2" value="메인화면"></td>
        </tr>
      </table></td>
      <!-- 관람등급아이콘 선택 -->
      <td>&nbsp;</td>
