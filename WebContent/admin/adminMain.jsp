		...
		<table width="1200" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<form name="uploadForm" id="uploadForm"
					...
					<table class="table" width="1200px" border="1px" bgcolor="#CCCCCC"
						height="300">
						<tbody id="fileTableTbody">
							<tr>
								<td id="dropZone"><span text-align="center">파일을 드래그
										하세요</span></td>
							</tr>
						</tbody>
					</table>
																		...
																		<table width="430" border="0" cellspacing="0"
																			...
																			<tr>
																				<c:forEach items="${arr }" var="dto">
																					<tr>
																						<td><span class="style9"><a
																								href="view.do?num=${dto.num}">${dto.subject }</a></span></td>
