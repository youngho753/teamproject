...
<html>
<head>
<link rel="stylesheet" type="text/css" href="/teamproject/css/adminMaincss.css">
...
>>>>>>> 0000b1e18ddc70a2da3bd0f00fd0f2d9310f44cf
                <tr>
                    <td id="dropZone">
                        파일을 드래그 하세요
                    </td>
    ...
    <a href="#" onclick="uploadFile(); return false;" class="btn bg_01">파일 업로드</a>
			...
			<tr>
				<td><table width="1100" border="0" align="center"
						...
						<tr>
							<td width="860" rowspan="19"><table width="860" border="0"
									cellspacing="0" cellpadding="0">
									<tr>
										<td width="840"><strong>영화목록</strong></td>
										<td width="20"><div align="center">
												<!-- 영화목록 보여질 부분 + 아이콘 (영화목록 리스트페이지로 연결)-->
												<a href="#"><img src="Imgs/list_plus_btn.gif" width="13"
													height="13" border="0"></a>
											</div></td>
									</tr>
									<tr background="Imgs/list_bg.gif">
										<td colspan="2"><img src="Imgs/list_bg.gif" width="1"
											height="15"></td>
									</tr>
									<tr>
										<td colspan="2"><table width="860" border="0"
												...
												<tr>
													<!-- 영화목록 이미지부분 -->
													<td colspan="2"><img src="Imgs/ex_list.gif"
														width="139" height="203"></td>
													<td width="4" rowspan="2">&nbsp;</td>
													<td colspan="2"><img src="Imgs/bohemi.jpg" width="139"
														height="203"></td>
													<td width="4" rowspan="2">&nbsp;</td>
													<td colspan="2"><img src="Imgs/myman.jpg" width="139"
														height="203"></td>
													<td width="4" rowspan="2">&nbsp;</td>
													<td colspan="2"><img src="Imgs/book.jpg" width="139"
														height="203"></td>
													<td width="4" rowspan="2">&nbsp;</td>
													<td colspan="2"><img src="Imgs/aqua.jpg" width="139"
														height="203"></td>
													<td width="4" rowspan="2">&nbsp;</td>
													<td colspan="2"><img src="Imgs/rock.jpg" width="139"
														height="203"></td>
												</tr>
												<tr>
													<td width="5">&nbsp;</td>
													...
													<td width="134"><span class="style10"><img
															src="Imgs/ex_12.gif" width="13" height="13"> 말모이 </span></td>
													<td width="5"><span class="style10"></span></td>
													<td width="134"><span class="style10"><img
															src="Imgs/ex_12.gif" width="13" height="13"> 보헤미안
															랩소디 </span></td>
													<td width="5"><span class="style10"></span></td>
													<td width="134"><span class="style10"><img
															src="Imgs/ex_12.gif" width="13" height="13"> 내안의 그놈
													</span></td>
													<td width="5"><span class="style10"></span></td>
													<td width="134"><span class="style10"><img
															src="Imgs/ex_12.gif" width="13" height="13"> 그린북 </span></td>
													<td width="5"><span class="style10"></span></td>
													<td width="134"><span class="style10"><img
															src="Imgs/ex_12.gif" width="13" height="13"> 아쿠아맨 </span></td>
													<td width="5"><span class="style10"></span></td>
													<td width="134"><span class="style10"><img
															src="Imgs/ex_12.gif" width="13" height="13"> 주먹왕
															랄프2 </span></td>
												</tr>
											</table></td>
									</tr>
									...
									<tr>
										<td colspan="2"><table width="860" border="0"
												cellspacing="0" cellpadding="0">
												<tr>
													<td><table width="430" border="0" cellpadding="0"
															cellspacing="0">
															<tr>
																<td width="840"><strong>영화정보</strong></td>
																<!-- 영화정보 리스트 보여질 부분 + 아이콘 (리스트로 연결)-->
																<td width="20"><div align="center">
																		<a href="#"><img src="Imgs/list_plus_btn.gif"
													...
													<td>&nbsp;</td>
													<td width="5">&nbsp;</td>
													<td width="430"><table width="430" border="0"
															cellpadding="0" cellspacing="0">
															<tr>
																<td width="840"><strong>상영관정보</strong></td>
																<!-- 상영관정보 리스트 보여질 부분 + 아이콘 (리스트로 연결)-->
															...
															<tr>
																<td colspan="2">
																	...
																	<table width="430" border="0" cellspacing="0"
																		cellpadding="0">
																		<tr>
																			<td><span class="style9"> [부산/대구/경상] 부산극장
																			</span></td>
																			<td><div align="right" class="style7 style10">01.21</div></td>
																		</tr>
																		<tr>
												...
												<tr>
													<td colspan="3">
														...
														<table width="874" border="0" align="center"
															cellpadding="0" cellspacing="0">
															<tr>
																<td><span class="style9">&lt;메이트&gt; 필름소사이어티
																		굿즈패키지 상영회 </span></td>
																<td><div align="right" class="style7 style10">01.22</div></td>
															</tr>
															<tr>
																<td><span class="style9">[이벤트]이벤트 내용을 입력하세요
																</span></td>
