	...
	<section class="moive_wrapper">
         ...
         <div class="movie_inner">
              <ul id="movielist">
                  ...
                  <li id="movie_border">
                     <div class="poster">
                         <a href="#"><img src="Imgs/aquaman.jpg"></a>
                     </div>
                  ...
                  <li id="movie_border">
                      <div class="poster">
                         <a href="#"><img src="Imgs/bumblebee.jpg"></a>
                     </div>
                      <div class="movie_name">
                        <ul>
                            <li><img src="Imgs/12_img.gif"></li> 
                  ...
                  <li id="movie_border">
                      <div class="poster">
                         <a href="#"><img src="Imgs/goosebaby.jpg"></a>
                     </div>
                      <div class="movie_name">
                        <ul>
                  ...
                  <li id="movie_border">
                      <div class="poster">
                         <a href="#"><img src="Imgs/greenbook.jpg"></a>
                     </div>
                      <div class="movie_name">
                        <ul>
                            <li><img src="Imgs/12_img.gif"></li>
                  ...
                  <li id="movie_border">
                      <div class="poster">
                         <a href="#"><img src="Imgs/insideman.jpg"></a>
                     </div>
                      <div class="movie_name">
                        <ul>
          ...
          <div class="movie_inner">
             <ul id="movielist">
                 ...
                 <li id="movie_border">
                      <div class="poster">
                         <a href="#"><img src="Imgs/mate.jpg"></a>
                     </div>
                      <div class="movie_name">
                        <ul>
                            <li><img src="Imgs/15_img.gif"></li>
                 ...
                 <li id="movie_border">
                      <div class="poster">
                         <a href="#"><img src="Imgs/rhapsody.jpg"></a>
                     </div>
                      <div class="movie_name">
                        <ul>
                            <li><img src="Imgs/12_img.gif"></li>
                ...
                <li id="movie_border">
                      <div class="poster">
                         <a href="#"><img src="Imgs/secretword.jpg"></a>
                     </div>
                      <div class="movie_name">
                        <ul>
                            <li><img src="Imgs/12_img.gif"></li>
                 ...
                 <li id="movie_border">
                      <div class="poster">
                         <a href="#"><img src="Imgs/spiderman.jpg"></a>
                     </div>
                      <div class="movie_name">
                        <ul>
                            <li><img src="Imgs/12_img.gif"></li> 
                 ...
                 <li id="movie_border">
                      <div class="poster">
                         <a href="#"><img src="Imgs/thekidking.jpg"></a>
                     </div>
                      <div class="movie_name">
                        <ul>
                            <li><img src="Imgs/all_img.gif"></li>
